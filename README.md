...
<a href="https://pkg.go.dev/github.com/stainless-sdks/cloneforce-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/cloneforce-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Cloneforce Go library provides convenient access to the Cloneforce REST API
...
```go
import (
	"github.com/stainless-sdks/cloneforce-go" // imported as cloneforce
)
```
...
```sh
go get -u 'github.com/stainless-sdks/cloneforce-go@v0.0.1'
```
...
The cloneforce library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/cloneforce-go/option).
...
`*cloneforce.Error`. This contains the `StatusCode`, `*http.Request`, and
...
if err != nil {
	...
	panic(err.Error()) // GET "/api/v1/clones": 400 Bad Request { ... }
}
```
...
We also provide a helper `cloneforce.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/cloneforce-go/issues) with questions, bugs, or suggestions.
