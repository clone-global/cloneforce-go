...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.V1.Clones.List(context.Background())
	if userAgent != fmt.Sprintf("Cloneforce/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.V1.Clones.List(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.V1.Clones.List(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.V1.Clones.List(deadlineCtx)
		if err == nil {
...
func TestContextDeadlineStreaming(t *testing.T) {
	...
	go func() {
		...
		stream := client.V1.Clones.Chats.Completions.NewStreaming(
			deadlineCtx,
			"chatId",
			cloneforce.V1CloneChatCompletionNewParams{
				CloneID: "cloneId",
				Message: "message",
			},
		)
